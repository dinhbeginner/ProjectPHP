...
$saleproduct = $thongke->bsp()->fetch();

if (isset($_POST['submit_month'])) {
  $selection = $_POST['month_selection']; // Changed from $_POST['selection']
  $year = date('Y', strtotime($selection));
  $month = date('m', strtotime($selection));
  $spb = $thongke->tkspt($year, $month);
  $doanhthunam = $thongke->doanhthutheonam($year)->fetch();
}

if (isset($_POST['submit_year'])) {
  $year = $_POST['year_selection']; // Changed from $_POST['selection']
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 col-xl-3">
            <div class="widget widget-tile">
              ...
              <div class="data-info">
                <div class="desc">Tổng Sản phẩm bán ra</div>
                <div class="value"><span class="indicator indicator-negative mdi mdi-chevron-down"></span><span class="number" data-toggle="counter" data-end="<?php echo $saleproduct['total'] ?>">0</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="widget widget-fullwidth be-loading">
              <div class="widget-head">
                ...
                <div class="button-toolbar d-none d-md-block">
                  <div class="btn-group">
                    ...
                    <form action="" method="post">
                      <input type="month" name="month_selection" value="<?php echo isset($selection) ? $selection : ''; ?>">
                      <input type="submit" class="btn btn-primary" name="submit_month" value="Select Month">

                      <input type="number" name="year_selection" value="<?php echo isset($year) ? $year : ''; ?>" placeholder="Enter Year">
                ...
                </div><span class="title">Tổng doanh thu theo năm: <?php echo number_format($doanhthunam['totals']) ?></span>
              </div>
