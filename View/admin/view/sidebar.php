                        ...
                        <ul class="sidebar-elements">
                            ...
                            <li class="parent"><a href="#"><i class="icon mdi mdi-inbox"></i><span>Category</span></a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="index.php?action=ListDanhmuc">List Danh Mục</a>
                                    </li>

                                </ul>
                            </li>
                            <li class="parent"><a href=""><i class="icon mdi mdi-chart-donut"></i><span>Brand</span></a>
                                <ul class="sub-menu">
                                    <li><a href="index.php?action=addbrand">Thêm Menu</a>
                                    </li>
                            ...
                            <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Product</span></a>
                                <ul class="sub-menu">
                                    <li><a href="index.php?action=ListProduct">List Product</a>
                                    </li>
